...
import com.narvaez.model.Product;
import com.narvaez.model.ProductCategory;
import com.narvaez.service.ProductService;
...
public class ProductController {
    ...
    @PutMapping("/api/product") // Update/ Create
    ...
    @PostMapping("/api/product") // Create / Update
    ...
    @GetMapping("api/product/{id}") // To Request Data
